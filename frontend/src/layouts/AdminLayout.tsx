...
import {
  LayoutDashboard, Users, CalendarDays, FileText, CalendarX,
  Palmtree, Wallet, User, LogOut, Menu, X, Building2, Car, Train,
} from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex items-center gap-3 px-4 py-4 border-b border-gray-100">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[11px] text-primary font-semibold tracking-wide">Admin Portal</p>
        </div>
        {onClose && (
          <button
            onClick={onClose}
      ...
      <div className="px-3 py-3 border-t border-gray-100 space-y-1">
        <div className="flex items-center gap-3 px-2 py-2.5 rounded-xl bg-gray-50">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-xs font-semibold text-gray-800 truncate">HR Administrator</p>
